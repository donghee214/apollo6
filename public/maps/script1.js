...
function initMap() {
    ...
    beach.addListener('click', function() {
        ...
        $(".hotspot").removeClass("right");
    });


    party3.addListener('click', function() {
        $(".hotspot").toggleClass("right");
...
$(document).on('pageinit', function(event) {
    ...
    $(".hotspot").on("taphold", function() {
        $(".extra").addClass("lower");

    });


    $("html").click(function() {
        $(".extra").removeClass("lower");
        $(".box").removeClass("right");
        $(".hotspot").removeClass("right");
    });
